...
const projects = [
  ...
  },
  {
    ...
    gallery: [
      ...
      { id: 7, image: '/projetos/Missão do Herói - Faculdade/jogo07.jpeg', title: 'Exploração do Mapa', description: 'Visão geral do cenário com os sistemas de colisão, movimentação do herói e interações com o ambiente do jogo.' },
      { id: 8, image: '/projetos/Missão do Herói - Faculdade/jogo08.jpeg', title: 'Sistema de Combate', description: 'Mecânicas de combate em tempo real com projéteis, IA de perseguição e efeitos visuais de impacto.' },
      { id: 9, image: '/projetos/Missão do Herói - Faculdade/jogo09.jpeg', title: 'Progressão de Missões', description: 'Interface de quests com objetivos dinâmicos, sistema de recompensas e checkpoints ao longo da aventura.' },
      { id: 10, type: 'video', image: '/projetos/Missão do Herói - Faculdade/gameplay.webm', title: 'Gameplay Completa', description: 'Vídeo demonstrativo com as mecânicas, trilha sonora, movimentação de IA e combates do projeto rodando em tempo real.' }
    ],
